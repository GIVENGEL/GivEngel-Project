...
<c:if test="${admin != null}">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<!--/.row-->
			<form id="deletefrm1" action="adminSponDeleteAction.giv" method="post">
											
							<div class="col-md-6">
								<input name="spon_no" id="spon_no" class="form-control" value="${spon.spon_no}" type="hidden">
								<div class="form-group">
									<h3>[${spon.spon_name }] 해당 후원 단체/캠페인을 삭제하시겠습니까?</h3>
									<label> 삭제하시려면 다음 번호를 입력해주세요 - [ ${spon.spon_no } ]</label>
									 <input id="spon_check" name="spon_check" class="form-control" type="number">
									 <label> "삭제"를 입력해주세요.</label>
									 <input id="spon_check2" name="spon_check2" class="form-control" type="text">
