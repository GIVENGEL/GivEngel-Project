					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="blog__item">
							<div class="blog__item__pic" style="border:2px solid #f9f9f9">
								...
								<c:otherwise><a href="adminSponModifyForm.giv?spon_no=${spon.spon_no }"><img src="${path}/resources/img/sponsor/${spon.spon_img }" alt="${spon.spon_name }"></a></c:otherwise>
								</c:choose>
							</div>
               ...
               <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="blog__item">
                     <div class="blog__item__pic">
                        <a href="adminSponModifyForm.giv?spon_no=${campaign.spon_no}"><img src="${path}/resources/img/sponsor/${campaign.spon_img }" alt="${campaign.spon_name }"></a>
                     </div> 
                     <div class="blog__item__text">
                        <ul>
                           <li>
