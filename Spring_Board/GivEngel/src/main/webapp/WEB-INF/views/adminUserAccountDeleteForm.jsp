...
<c:if test="${admin != null}">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<!--/.row-->
			<form id="deletefrm1" action="adminUserAccountDeleteAction.giv" method="post">
											
							<div class="col-md-6">
								<input name="user_no" id="user_no" class="form-control" value="${users.user_no}" type="hidden">
								<div class="form-group">
									<h3>[${users.user_id }] 해당 계정을 탈퇴시키겠습니까?</h3>
									<label> 삭제하시려면 다음 번호를 입력해주세요 - [ ${users.user_no } ]</label>
									 <input id="user_check" name="user_check" class="form-control" type="number">
									 
									 <hr/>
									 <label> "삭제"를 입력해주세요.</label>
									 <input id="user_check2" name="user_check2" class="form-control" type="text">
						<hr>
		...
		<script>
			window.onload = function() {
				...
				function checkform() {
					...
					var user_check2 = $("#user_check2").val();
					var check1 = false;
					if (user_check != $("#user_no").val() ) {
						alert("번호가 틀렸습니다.");
						return false;
					}
					if (user_check2 != "삭제") {
