...
<body>
				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__option">
							...
							<span style=" overflow: hidden;text-overflow: ellipsis;white-space: nowrap; width: 100px;height: 20px;">${goodVO.good_name}</span>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="related-product">
		<div class="container">
			...
			<div class="row">
			<!-- start foreach -->
			<c:forEach items="${ latestGood1}" var='latestGood1' begin='0' end='7'>
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						...
						<div class="product__item__text">
							...
							<h5><fmt:setLocale value="ko_KR" /><fmt:formatNumber type='currency' value="${latestGood1.good_price }" /></h5>
						</div>
					</div>
				</div>
			</c:forEach>
