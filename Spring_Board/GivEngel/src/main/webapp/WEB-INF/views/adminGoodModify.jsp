					...
					$.ajax({
						...
						success : function(data) {
							...
							for(var i=0;i<list.length;i++){
								$("#searchResult").append('<div class="col-sm-3 col-md-2"><div class="thumbnail"><img class="good_img" src="${path}/resources/img/good/'+data.list[i].good_img+'"  alt="'+data.list[i].good_name+'" ><div class="caption"><h4>'+data.list[i].good_name+'</h4><p>'+data.list[i].good_price +' 원</p><p><a href="adminGoodModifyForm.giv?good_no='+data.list[i].good_no+'" class="btn btn-primary" role="button">수정하기</a></p></div></div></div>')
