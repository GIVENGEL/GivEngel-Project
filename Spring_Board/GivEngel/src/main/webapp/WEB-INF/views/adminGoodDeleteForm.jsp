...
<c:if test="${admin != null}">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<!--/.row-->
			<form id="deletefrm1" action="adminGoodDeleteAction.giv" method="post">
											
							<div class="col-md-6">
								<input name="good_no" id="good_no" class="form-control" value="${good.good_no}" type="hidden">
								<div class="form-group">
									<h3>[${good.good_name }] 해당 상품을 삭제하시겠습니까?</h3>
									<label> 삭제하시려면 다음 번호를 입력해주세요 - [ ${good.good_no } ]</label>
									 <input id="good_check" name="good_check" class="form-control" type="number">
									 <label> "삭제"를 입력해주세요.</label>
									 <input id="good_check2" name="good_check2" class="form-control" type="text">
	...
	alert("하이")
				...
				function checkform() {
					...
					var good_check2 = $("#good_check2").val();
					var check1 = false;
					if (good_check != $("#good_no").val() ) {
						alert("번호가 틀렸습니다.");
						return false;
					}
					if (good_check2 != "삭제") {
